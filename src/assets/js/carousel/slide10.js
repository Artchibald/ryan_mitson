  ...
  render() {
    return (
      <React.Fragment>
        ...
        <ProgressiveImage
          className="desk"
          src={`http://www.ryanmitson.com/ryan-mitson-drag-img/slide10.jpg?${new Date().getTime()}`}
          placeholder={Placeholder}
        />
        <ProgressiveImage
          className="mob"
          src={`http://www.ryanmitson.com/ryan-mitson-drag-img/slide10_mob.jpg?${new Date().getTime()}`}
          placeholder={Placeholder}
        />
      </React.Fragment>
    );
